! function(e, t) {
    ...
    function s(e, t, n) {
        return o(t), window.chrome && window.chrome.storage && e && e.indexOf("127.0.0.1") == -1 ? void i(function(o) {
            o[e] = t, chrome.storage.local.set({
                "device-settings": o
            }, n)
        }) : void(n && n())
    }
    ...
    function a(e) {
        ...
        var t = e.displaySettings && e.displaySettings.name,
            n = 0;
        for (var o in A) {
            var i = A[o];
            if (i.name == t) {
    ...
    function b(e) {
        var t = $("#notificationModal"),
            n = t.find("#modal-ok"),
            o = t.find("#modal-cancel");
    ...
    ! function() {
            ...
            function n(n) {
                ...
                if (!i.done) {
                    ...
                    if (i.value == Error) r = !0, i = o.next(e);
                        ...
                        if (i.value != m) throw new Error("Unexpected yield value for callback. Only Error and Success allowed.");
                        s = !0, i = o.next(t)
                    }
                    ...
                    if (i.value == m && s) throw new Error("Success callback already defined");
                    if (i.value != Error && i.value != m) throw new Error("Unexpected yield value for callback. Only Error and Success allowed.");
            ...
            t.sendHostCommand = function(e, t) {
                ...
                function n(e) {
                    ...
                    if (n != -1) {
                        ...
                        var v;
                        v = s.model ? s.model.replace("_", " ") : i, o[i] = {
                            serialno: i,
                            name: v,
                            status: a,
                            properties: t
        ...
        function() {
                ...
                chrome.usb.getUserSelectedDevices({
                    ...
                    $.each(e, function(e, t) {
                        ...
                        tracker.sendEvent("select-device", n), adbServer.refreshDevice(t, function(e) {
                            if (e) tracker.sendEvent("connect-device", e.properties["ro.product.name"], t.vendorId.toString(16) + ":" + t.productId.toString(16), n);
                            else {
            ...
            function t() {
                y(!1, function(e) {
                    e ? $("#login-container").hide() : $("#login-container").show()
                })
            }
            ...
            function l(e, t, n, o, s, c, a, l, f, p, m) {
                u = e, h = s, v = o, $("#share-all-check").prop("checked", l), Object.keys(e).length || !p ? $("#not-found").hide() : $("#not-found").show(), !f || p ? ($("#connect-android").show(), $("#no-devices").hide()) : ($("#connect-android").hide(), $("#no-devices").show()), f ? ($("#adb-server-status").show(), p ? $("#adb-server-status").text("Using built-in Vysor ADB.") : $("#adb-server-status").text("Using Android SDK ADB binary.")) : navigator.userAgent.indexOf("Windows NT 10") != -1 && null == m ? ($("#adb-server-status").show(), $("#adb-server-status").html("Windows 10 users MUST download the latest <a href='https://adb.clockworkmod.com' target='_blank'> Universal ADB Drivers</a>")) : ($("#adb-server-status").show(), $("#adb-server-status").text("ADB not running. Click Find Devices to get started."));
                var y = Object.keys(e),
                    k = Object.keys(v);
                if ($.each($(".vysor-device"), function(t, n) {
                    ...
                    if (!t[o] || !t[o].farm) {
                        var s = e[o],
                            l = s.name,
                            f = $("#devices").find('.vysor-device[name="' + o + '"]');
                        if (!f.length) {
                            ...
                            p.click(function(e) {
                                ...
                                e.stopPropagation()
                            })), t[o] ? ($(v).removeClass("btn-default").addClass("btn-danger"), v.text("Disconnect"), v.click(function(e) {
                                e.stopPropagation(), disconnectSharedDevice(o)
                            })) : ($(v).removeClass("btn-danger").addClass("btn-default"), v.click(i("Vysor Share", function(e) {
                                ...
                                var t = u[o];
                                if ("unauthorized" == t.status) w(null, 'Check your Android device and accept the "Allow USB Debugging" prompt. You may need to disconnect and reconnect your Android for the dialog to show.');
                                else if ("offline" == t.status) w(null, "Your Android USB connection is offline. Please try rebooting your Android.");
                                else {
                        ...
                        if (h[o] && h[o].userInfo && h[o].userInfo.picture) {
                            var y = h[o].userInfo;
                            p.attr("alt", "Device in use by " + y.name), x(y.picture, function(e) {
                                p.attr("src", e)
                            }), p.show()
                        } else p.hide();
                        t[o] || (h[o] ? v.text("Unshare") : v.text("Share"))
                    }
                });
                else {
                    var S = $("#devices").find("#no-vysor-devices");
                    S.length || (S = $('<a id="no-vysor-devices" href="https://plus.google.com/110558071969009568835/posts/Bb2wMXVwsQ7" target="_blank"><div class="alert alert-danger">No devices found. Make sure Android USB Debugging is enabled.</div></a>'), $("#devices").append(S)), f && !p || ($("#choose-header").hide(), S.hide())
                }
                            ...
                            $(c).each(function(e, i) {
                                function c(e) {
                                    ...
                                    if (o.sharedDevices && o.sharedDevices[i] && o.sharedDevices[i].userInfo) {
                                        ...
                                        b({
                                            title: "Android In Use",
                                            body: "This Android is currently in use by " + g.name + ". Do you want to boot them off?",
                                ...
                                if (s.sharedDevices && s.sharedDevices[i] && s.sharedDevices[i].userInfo) {
                                    var g = s.sharedDevices[i].userInfo;
                                    p.attr("alt", "Device in use by " + g.name), x(g.picture, function(e) {
                                        p.attr("src", e)
                                    }), p.show()
                                } else p.hide();
            ...
            chrome.identity.onSignInChanged.addListener(function() {
                ...
                function n() {
                    chrome.storage.local.get(["vysorUsage"], function(e) {
                        ...
                        t || (t = 0);
                        var n = t / 36e5;
                        n = Math.round(2 * n) / 2, console.log("hours used", n), $("#used").html("You've used Vysor for " + n + " hours.<br/>An advertisement will be shown every 30 minutes while viewing an Android.<br/>Upgrade to remove ads and unlock all features.")
                    }), setTimeout(n, 36e5)
                }
                navigator.platform.toLowerCase().indexOf("win") == -1 && $("#windows").hide(), $("#vysor-keyboard-check").change(function() {
                    ...
                    b({
                        ...
                        function t() {
                            b({
                                ...
                                ok: function() {
                                    $("#notificationModal").modal("hide"), g(e), setTimeout(t, 500)
                                },
                                title: "Bug Report",
                ...
                }), $("#logging-in").hide(), $("#login-container").hide(), $("#connect-android").click(e), $("#vysor-version").text("Vysor Version " + chrome.runtime.getManifest().version), $("#reload-vysor").click(function() {
                    ...
                    chrome.storage.local.remove("lastDeviceFarmRegistrationId"), chrome.storage.local.set({
                        "share-all-devices": this.checked
                    }), this.checked ? startDeviceFarm(!0, function(e, t) {
                        if (t) return w("Vysor Share Server", t), void $("#share-all-check").prop("checked", !1);
                        k(e);
                        var n = chrome.runtime.getManifest().name;
                        w("Copied " + n + " Share Server URL to clipboard.", e), g(e)
                    }) : stopDeviceFarm()
                }), chrome.storage.local.get("connect-automatically", function(e) {
                    var t;
                    t = e["connect-automatically"] === !1 ? 2 : e["connect-automatically"] === !0 ? 0 : e["connect-automatically"] || 0, $("#connect-automatically-select").prop("selectedIndex", t);
                    ...
                    chrome.storage.local.set({
                        lastConnectAddress: e
                    }), Adb.sendHostCommand("host:disconnect:" + e, function(t, n) {
